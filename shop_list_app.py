...
app.layout= html.Div(
    [
        ...
        dbc.Row([dbc.Col(html.Div("Protein"),width=2),dbc.Col(dcc.Checklist(id="prot_list",
            options=[
            {'label': 'Chicken', 'value':'Chicken'},
            {'label': 'Steaks', 'value':'Steaks'},
            {'label': 'Fish', 'value':'Fish'},
            {'label': 'Eggs', 'value':'Eggs'}], inputStyle={"margin-left": "20px"}))]),
        dbc.Row([dbc.Col(html.Div("Carbohydrates"),width=2),dbc.Col(dcc.Checklist(id="carb_list",
            options=[
            {'label': 'Rice', 'value':'Rice'},
            {'label': 'Lentils', 'value':'Lentils'},
            {'label': 'Noodles', 'value':'Noodles'},
            {'label': 'Beans', 'value':'Beans'}], inputStyle={"margin-left": "20px"}))]),
        dbc.Row([dbc.Col(html.Div("Veggies"),width=2),dbc.Col(dcc.Checklist(id="veg_list",
            options=[
            ...
            {'label': 'Cucumbers', 'value':'Cucumbers'}], inputStyle={"margin-left": "20px"}))]),
        dbc.Row([dbc.Col(html.Div("Spices"),width=2),dbc.Col(dcc.Checklist(id="spice_list",
            options=[
            {'label': 'Garlic', 'value':'Garlic'},
            {'label': 'Ginger', 'value':'Ginger'},
            {'label': 'Chilli', 'value':'Chilli'},
            {'label': 'Curry', 'value':'Curry'}], inputStyle={"margin-left": "20px"}))]),
        dbc.Row([dbc.Col(html.Div("Others"),width=2),dbc.Col(dcc.Checklist(id="other_list",
            options=[
            ...
            {'label': 'Oil', 'value':'Oil'},
            {'label': 'Chicken Stock', 'value':'Chicken Stock'}], inputStyle={"margin-left": "20px"}))]),
        dbc.Row([dbc.Col(html.H3("What do you want to make?"),width=4),
        dbc.Col(dcc.Dropdown(id='dish', options=[
